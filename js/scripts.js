...
$(function () {
    ...
    if (width > 991) {
        ...
        // ── Stack title: fade in on enter, fade out on scroll ──
        gsap.set(".features .stack-title", { opacity: 0 });

        const stackFadeIn = gsap.timeline({
            scrollTrigger: {
                trigger: ".features",
                start: "top 80%",
                onEnter: () => {
                    gsap.to(".features .stack-title", {
                        opacity: 1,
                        duration: 0.6,
                        ease: "power2.out"
                    });
     ...
     const stackFadeOut = gsap.timeline({
            scrollTrigger: {
                trigger: ".features .stack-title",
                start: "top 20%",   // was "top top"
                end: "bottom 60%",
                scrub: 1,
            }
        });

        stackFadeOut.to(".features .stack-title h2", {
            opacity: 0,
            duration: 1,
            ease: "power1.in"
        });
// ── Pin why-sub-head alongside the stack title ──
const whySubHead = gsap.timeline({
    scrollTrigger: {
        trigger: ".why-sub-head",
        start: "center center",
        endTrigger: ".features",
        end: "bottom bottom",
        pin: true,
        ...
        // ── Pin the stack title during scroll ──
        const fe = gsap.timeline({
            scrollTrigger: {
                trigger: ".features .stack-title",
                start: "center center",
